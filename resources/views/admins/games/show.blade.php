      ...
      <div class="row mt-5">
        <div class="col-md-4">
          <a href="{{ route('games.edit', $game->id) }}">
            <img src="{{ $game->link_img }}" alt="Game"
              style="min-height:500px; max-height: 500px; border-radius:25px ">
          </a>
        </div>
        <div class="card-body" style="margin-left: -150px">
          <div class="font-weight-bold game-name d-flex flex-col" style="font-size: 3rem">
            <a href="{{ route('games.edit', $game->id) }}">{{ $game->name }}</a>
          ...
          <p class="font-weight-bold mt-5" style="font-size: 1.5rem; color:gray;">О игре</p>
          <div style="line-height: 20px">
              ...
              <div class="col-sm-6">
                <table class="table table-borderless">
                  <tr>
                    ...
                    <td class="text-right text-muted border-bottom">{{ $game->country->name }}</td>
                  </tr>
                  <tr>
                    <td class="text-left border-bottom">Продолжительность:</td>
                    <td class="text-right text-muted border-bottom">{{ $game->duration }} мин.</td>
                  </tr>
                  <tr>
                    <td class="text-left border-bottom">Дата выхода:</td>
                    <td class="text-right text-muted border-bottom">{{ $game->year_of_issue }}</td>
                  </tr>
                  <tr>
                    <td class="text-left border-bottom">Возраст:</td>
                    <td class="text-right text-muted border-bottom">{{ $game->age }}+</td>
                  </tr>
                  <tr>
            ...
            <div class="d-flex flex-row justify-content-end btn-secondary2" style="gap: 30px">
              <a class="btn btn-secondary button-save" href="{{ $game->link_kinopoisk }}">Ссылка на Кинопоиск
                </ф>
                <a class="btn btn-secondary button-save" href="{{ $game->link_video }}">Ссылка на
                  трейлер</a>
            </div>
          </div>
        </div>
                ...
                <div>
                  <div class="d-flex">
                    <h5 class="card-title text-muted">
                      {{ $review->user ? $review->user->username : 'Пользователь не найден' }}</h5>
