                  ...
                  <div>
                    <div class="d-flex">
                      <h5 class="card-title text-muted">
                        {{ $rating->user ? $rating->user->username : 'Пользователь не найден' }}</h5>
                    ...
                    <div class="d-flex flex-col card-subtitle text-muted">
                      ...
                      <a class="ml-2" href="{{ route('gameinfo.show', $rating->game->id) }}">
                        {{ $rating->game->name }}
                      </a>
                    </div>
                  </div>
    ...
    window.onload = function() {
      ...
      search.addEventListener('keyup', function() {
        ...
        for (let i = 0; i < reviews.length; i++) {
          ...
          let gameTitle = review.querySelector('.card-subtitle a').textContent.toLowerCase();
